...
if __name__ == '__main__':
    ...
    cm = Inference(device, 'ResNet_0826_CBAM_5slice', data_type='train', n_classes=4, weights_list=None)
    ShowCM(cm)
    cm = Inference(device, 'ResNet_0826_CBAM_5slice', data_type='val', n_classes=4, weights_list=None)
    ShowCM(cm)
    cm = Inference(device, 'ResNet_0826_CBAM_5slice', data_type='test', n_classes=4, weights_list=None)
    ShowCM(cm)